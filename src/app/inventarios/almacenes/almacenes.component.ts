...
export class AlmacenesComponent implements OnInit {
  ...
  filterData(ref: string) {
    this.almacenesFiltrados = this.data_.filter( value => 
      value['Abrev'].startsWith(ref) || value['Nombre'].startsWith(ref) || value['Dir'].startsWith(ref) || value['Supervisor'].startsWith(ref) || value['Mail'].startsWith(ref) || value['Telefono'].startsWith(ref)
    );
  }
