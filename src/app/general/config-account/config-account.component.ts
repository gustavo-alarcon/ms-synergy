...
export class ConfigAccountComponent implements OnInit {
  ...
  editAction(idx: number, idx_user: number) {
    ...
    this.modAccountForm.patchValue({
      ...
      doc_t_correlativoInicial:this.accountList[idx]['doc_t_correlativoInicial'],
  ...
  saveAction( idx: number) {
    ...
    this.modAccountForm.patchValue({
      ...
      alm_b_guardar:this.filterValue(this.modAccountForm.value['alm_b_guardar']),
      alm_b_borrar:this.filterValue(this.modAccountForm.value['alm_b_borrar']),
      alm_t_direccion:this.filterValue(this.modAccountForm.value['alm_t_direccion']),
      alm_t_supervisor:this.filterValue(this.modAccountForm.value['alm_t_supervisor']),
      alm_t_mail:this.filterValue(this.modAccountForm.value['alm_t_mail']),
      alm_t_telefono:this.filterValue(this.modAccountForm.value['alm_t_telefono']),
      ...
      ter_b_guardar:this.filterValue(this.modAccountForm.value['ter_b_guardar']),
      ter_b_borrar:this.filterValue(this.modAccountForm.value['ter_b_borrar']),
      ter_t_direccion:this.filterValue(this.modAccountForm.value['ter_t_direccion']),
      ter_t_contacto:this.filterValue(this.modAccountForm.value['ter_t_contacto']),
      ter_t_mail:this.filterValue(this.modAccountForm.value['ter_t_mail']),
      ter_t_telefono:this.filterValue(this.modAccountForm.value['ter_t_telefono']),
      ...
      doc_b_guardar:this.filterValue(this.modAccountForm.value['doc_b_guardar']),
      ...
      doc_t_correlativoInicial:this.filterValue(this.modAccountForm.value['doc_t_correlativoInicial']),
      doc_t_correlativoActual:this.filterValue(this.modAccountForm.value['doc_t_correlativoActual']),
      ...
      gru_b_guardar:this.filterValue(this.modAccountForm.value['gru_b_guardar']),
      ...
      pro_b_crearPaquete:this.filterValue(this.modAccountForm.value['pro_b_crearPaquete']),
      pro_b_editarPaquete:this.filterValue(this.modAccountForm.value['pro_b_editarPaquete']),
      pro_b_guardarPaquete:this.filterValue(this.modAccountForm.value['pro_b_guardarPaquete']),
      pro_b_borrarPaquete:this.filterValue(this.modAccountForm.value['pro_b_borrarPaquete']),
      pro_b_crearProducto:this.filterValue(this.modAccountForm.value['pro_b_crearProducto']),
      pro_b_editarProducto:this.filterValue(this.modAccountForm.value['pro_b_editarProducto']),
      pro_b_guardarProducto:this.filterValue(this.modAccountForm.value['pro_b_guardarProducto']),
      pro_b_borrarProducto:this.filterValue(this.modAccountForm.value['pro_b_borrarProducto']),
      pro_p_paquetes:this.filterValue(this.modAccountForm.value['pro_p_paquetes']),
      pro_p_productos:this.filterValue(this.modAccountForm.value['pro_p_productos']),
      pro_d_cantidad:this.filterValue(this.modAccountForm.value['pro_d_cantidad']),
      pro_d_precio:this.filterValue(this.modAccountForm.value['pro_d_precio']),
      pro_t_stockInicial:this.filterValue(this.modAccountForm.value['pro_t_stockInicial']),
      pro_t_stockActual:this.filterValue(this.modAccountForm.value['pro_t_stockActual']),
      pro_t_stockEmergencia:this.filterValue(this.modAccountForm.value['pro_t_stockEmergencia']),
      pro_t_stockAlerta:this.filterValue(this.modAccountForm.value['pro_t_stockAlerta']),
      pro_t_moneda:this.filterValue(this.modAccountForm.value['pro_t_moneda']),
      pro_t_precioCompra:this.filterValue(this.modAccountForm.value['pro_t_precioCompra']),
      pro_t_precioVenta:this.filterValue(this.modAccountForm.value['pro_t_precioVenta']),

      reg_seccion:this.filterValue(this.modAccountForm.value['reg_seccion']),
      reg_doc_entrada:this.filterValue(this.modAccountForm.value['reg_doc_entrada']),
      reg_doc_salida:this.filterValue(this.modAccountForm.value['reg_doc_salida']),
      reg_doc_transferencia:this.filterValue(this.modAccountForm.value['reg_doc_transferencia']),
      reg_doc_ajusteEntrada:this.filterValue(this.modAccountForm.value['reg_doc_ajusteEntrada']),
      reg_doc_ajusteSalida:this.filterValue(this.modAccountForm.value['reg_doc_ajusteSalida']),
      reg_t_prodPrecioCompra:this.filterValue(this.modAccountForm.value['reg_t_prodPrecioCompra']),
      reg_t_paqPrecioCompra:this.filterValue(this.modAccountForm.value['reg_t_paqPrecioCompra']),

      kardex_seccion:this.filterValue(this.modAccountForm.value['kardex_seccion']),
      stock_seccion:this.filterValue(this.modAccountForm.value['stock_seccion']),
      movimientos_seccion:this.filterValue(this.modAccountForm.value['movimientos_seccion']),
  ...
  borrarAction( tabla: string, idx: number) {
    ...
    //this.inventariosService.deleteAccount(this.borrarData);
    this.edit[this.currentIdx]['value'] = false;
    this.editMode = false;
