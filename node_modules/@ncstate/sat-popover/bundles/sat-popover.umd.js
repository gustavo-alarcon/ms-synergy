(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/cdk/overlay'), require('@angular/cdk/a11y'), require('@angular/cdk/coercion'), require('@angular/animations'), require('@angular/cdk/keycodes'), require('@angular/cdk/portal')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/cdk/overlay', '@angular/cdk/a11y', '@angular/cdk/coercion', '@angular/animations', '@angular/cdk/keycodes', '@angular/cdk/portal'], factory) :
	(factory((global.popover = {}),global.ng.core,global.ng.common,global.ng.cdk.overlay,global.ng.cdk.a11y,global.ng.cdk.coercion,global.ng.animations,global.ng.cdk.keycodes,global.ng.cdk.portal));
}(this, (function (exports,core,common,overlay,a11y,coercion,animations,keycodes,portal) { 'use strict';
 ...
 */
var PopoverNotification = /** @class */ (function () {
...
var PopoverAnchoringService = /** @class */ (function () {
    ...
    function () {
        ...
        this._overlayRef
            .keydownEvents()
            .pipe(tap(function (event) { return _this._popover.overlayKeydown.emit(event); }), filter(function (event) { return event.keyCode === keycodes.ESCAPE; }), filter(function () { return _this._popover.interactiveClose; }), takeUntil(this.popoverClosed), takeUntil(this._onDestroy))
            .subscribe(function () { return _this.closePopover(); });
    };
    /**
